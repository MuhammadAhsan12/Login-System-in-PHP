			...
			<div class="card-header">
				...
				if($_SERVER['REQUEST_METHOD'] == 'POST'){
					...
					if($result != ""){
						...
						// echo "<script type='text/javascript'>alert('the following error occured: $result');</script>";
						echo $result;
						echo "</div>";
					}else{
			...
			<div class="card-body">
                <form method="post" action="">
					...
					<div class="input-group form-group">
						...
						<input value="<?php echo $password ?>" name="password" type="password" class="form-control" placeholder="password">
					</div>
